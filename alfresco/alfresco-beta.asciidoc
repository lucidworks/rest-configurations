...
== Exclude Property
The exclusion property is a key-value pair, where the key represents the name of the exclusion entry, and the value contains the corresponding regular expression.
