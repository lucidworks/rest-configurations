...
Allows to specify a list of key-value pair to exclude objects from the fetching:
...
** Value: The value contains a regular expression that will be matched against the field value in the object. If the match succeeds, the entire object will be exclude
