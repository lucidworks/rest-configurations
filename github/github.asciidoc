...
The JSON template file `github-repo.json` crawls a single specific repository via `/repos/{owner}/{repo}`. To crawl multiple repositories, create one datasource per repository.
